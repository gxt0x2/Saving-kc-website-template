...
export const clay: CountyData = {
  ...
  countyFaqs: [
    {
      question: 'When are Clay County property taxes due in 2026?',
      answer: '<strong>Clay County property taxes are due December 31 each year.</strong> If you miss the deadline, penalties start in January at <strong>1% per month</strong> under RSMo Chapter 140. The county prints a delinquent list in the <strong>Liberty Tribune</strong> before the late August 2026 lien sale. Once listed, time runs short. <strong>Saving KC Homebuyers (816-429-2900)</strong> can buy your home in as few as <strong>7 days</strong> and clear all tax debt at closing. Our office at 1705 Baltimore Ave is just <strong>18 miles</strong> from the Clay County Courthouse in Liberty.',
    },
    {
      question: 'Where is the Clay County probate court?',
      answer: '<strong>Probate in Clay County goes through the 7th Judicial Circuit Court</strong> at 11 S Water St in Liberty. The court handles estates, guardianships, and conservatorships under <strong>RSMo Chapter 473</strong>. Estates under $40,000 may skip full probate with a small-estate affidavit. If you need to sell an <a href="/situations/inherited-property/">inherited property</a>, <strong>Saving KC Homebuyers (816-429-2900)</strong> can close as soon as the court allows. No repairs or cleanout needed. We are just <strong>18 miles</strong> from the Liberty courthouse.',
    },
    {
      question: 'How does the 2026 Northland housing boom affect selling a distressed home in Clay County?',
      answer: '<strong>Clay County\'s Northland growth corridor has pushed home values up, but distressed homes still struggle to sell.</strong> Buyers chase new builds in Liberty and Shoal Creek. If your home needs major work, it may sit on the MLS for months. Rising odd-year reassessments mean higher tax bills on a house you cannot afford to fix. <strong>Saving KC (816-429-2900)</strong> buys homes in any condition. We base offers on local market data, not post-renovation value. Our office at 1705 Baltimore Ave is <strong>18 miles</strong> from Liberty. <a href="/tax-delinquent/">Learn about tax-delinquent options.</a>',
    },
    {
      question: 'Can I sell a Clay County house with title issues from old industrial use?',
      answer: '<strong>Yes. Properties in North Kansas City and Clay County\'s industrial corridors often have complex title histories.</strong> Environmental liens, old deed restrictions, and commercial-use clouds scare off traditional lenders. <strong>Saving KC Homebuyers (816-429-2900)</strong> pays cash, so there is no lender to walk away. We work with Liberty-area title companies to resolve issues at closing. Our office at 1705 Baltimore Ave is only <strong>18 miles</strong> from the Clay County Courthouse. Call today for a <strong>free title review</strong>.',
    },
    {
      question: 'Can I sell an inherited house in Clay County before probate is finished?',
      answer: '<strong>Yes. Missouri law lets you sell inherited real estate during probate with court approval.</strong> The Clay County Circuit Court, 7th Judicial Circuit, in Liberty routinely grants estate sales under <strong>RSMo Chapter 473</strong> when proceeds benefit the estate. A small-estate affidavit may apply for estates under $40,000. <strong>Saving KC Homebuyers (816-429-2900)</strong> buys <a href="/situations/inherited-property/">inherited homes</a> in any condition. No cleanout, no repairs, no visits needed. We are <strong>18 miles</strong> from the Liberty probate courthouse.',
    },
    {
      question: 'How does Missouri\'s 2025 Electronic Wills Act affect Clay County probate in 2026?',
      answer: '<strong>Missouri now recognizes electronic wills signed after August 28, 2025, under RSMo 474.600.</strong> If your loved one created a digital will, the Clay County Circuit Court, 7th Judicial Circuit, may accept it. This can speed up the <a href="/probate/">probate filing process</a>. Whether the will is paper or electronic, <strong>Saving KC (816-429-2900)</strong> can buy the inherited property at any stage. Our office at 1705 Baltimore Ave is just <strong>18 miles</strong> from the Liberty courthouse.',
    },
    {
      question: 'What happens at the 2026 Clay County tax lien sale?',
      answer: '<strong>Clay County holds its annual tax lien sale in late August 2026 at the courthouse in Liberty.</strong> Under <strong>RSMo Chapter 140</strong>, properties with unpaid taxes are auctioned to lien buyers. After the sale, you have a limited redemption window. The longer you wait, the more you owe. <strong>Saving KC Homebuyers (816-429-2900)</strong> can buy your home <strong>before the auction</strong> and clear all debt at closing. We close in as few as 7 days. Our office is <strong>18 miles</strong> from the courthouse. <a href="/tax-delinquent/">See your tax-delinquent options.</a>',
    },
    {
      question: 'Can I sell a house with a tax lien in Clay County?',
      answer: '<strong>Yes. You do not need to pay off tax liens before selling your Clay County home.</strong> At closing, the title company uses sale proceeds to clear all liens — tax liens, mechanic\'s liens, and judgment liens under <strong>RSMo Chapter 140</strong>. You keep whatever equity remains. <strong>Saving KC (816-429-2900)</strong> buys properties with liens regularly and can close in as few as <strong>7 days</strong>. Our office at 1705 Baltimore Ave is <strong>18 miles</strong> from the Clay County Courthouse in Liberty.',
    },
  ],
  cities: [
    {
